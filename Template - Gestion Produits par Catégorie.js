...
function seedDefaultCourseData(categoryName) {
  ...
  try {
    ...
    // Cours
    const coursData = [
      ["C-001", "Maîtriser l'architecture microservices : les 10 pièges d'un CTO", "Un cours intensif qui va au-delà des tutoriels basiques pour vous enseigner les stratégies et les erreurs à éviter, tirées de 15 ans d'expérience terrain.", "8h 30min", "Expert", 75000, "https://www.youtube.com/embed/Plq333-4k6E", "https://i.postimg.cc/pX3dYj8B/course-microservices.jpg", "0", "1200", "Maîtriser les patterns de communication; Concevoir des API résilientes; Gérer la consistance des données.", "Bases en backend; Connaissance des API REST.", "Pensez comme un architecte système.", "Développeurs Backend avec 3+ ans d'expérience.", "Jean Dupont", "CTO @ TechInnov", "Après avoir mené 3 transformations monolithiques, j'ai condensé mes leçons (et échecs) dans ce cours.", "4.8", "125 Avis"],
      ["C-002", "React Avancé : Hooks, Performance et State Management", "Optimisez vos applications React en maîtrisant les concepts avancés que les tutoriels survolent.", "12h 15min", "Intermédiaire", 60000, "https://www.youtube.com/embed/N3AkSS5hXMA", "https://i.postimg.cc/Yq7p4Y4j/course-react.jpg", "0", "1200", "Utiliser les hooks personnalisés; Optimiser le rendu avec useMemo et useCallback; Gérer un état global sans Redux.", "Bonnes bases de React (composants, props, state).", "Écrivez du code React plus propre, plus rapide et plus maintenable.", "Développeurs Frontend voulant passer au niveau supérieur.", "Aïcha Diallo", "Lead Frontend Dev @ WebScale", "J'ai vu trop de projets React devenir des usines à gaz. Ce cours vous donne les clés pour éviter ça.", "4.9", "210 Avis"],
      ...
      ["C-009", "Gestion de Projet Agile pour Leaders Techniques", "Devenez le Tech Lead que tout le monde veut suivre. Maîtrisez Scrum et Kanban du point de vue technique.", "8h 45min", "Intermédiaire", 68000, "https://www.youtube.com/embed/J49_xa-2Vz4", "https://i.postimg.cc/prM8gJzG/course-agile.jpg", "0", "1200", "Estimer des tâches techniques; Animer des réunions efficaces; Gérer la dette technique dans un sprint.", "Expérience en tant que développeur.", "Le pont entre le code et la stratégie produit.", "Développeurs seniors, Tech Leads, Team Leads.", "Hélène Martin", "Engineering Manager @ AgileSoft", "J'ai transformé des équipes de développeurs en machines de livraison agiles. Voici ma méthode.", "4.8", "115 Avis"],
